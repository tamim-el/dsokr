...
plt.tight_layout()
plt.savefig('Figures/synthetic_lev_scores.pdf', transparent=True)
plt.close()
...
plt.tight_layout()
plt.savefig('Figures/synthetic_perfecth.pdf', transparent=True)
plt.close()
...
ax.set_yticklabels([str(i) for i in ax.get_yticks()], fontsize = 50)
plt.tight_layout()
plt.savefig('Figures/synthetic_mse.pdf', transparent=True)
plt.close()